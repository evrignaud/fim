...
image:icons/fim-96.png[Fim]

The purpose of Fim is to manage a workspace and be able to know where we are in the work we are doing.
When we do a lot of stuff at the same time, things take time and we lose the thread.
...
include::how-does-it-works.adoc[]

include::fim-workflow.adoc[]

include::fim-usage.adoc[]

include::how-can-i-use-fim.adoc[]
