...
import org.fim.command.RemoveMirroredFilesCommand;
...
public class Main
{
	...
	private static List<AbstractCommand> buildCommands()
	{
		return Arrays.asList(
				...
				new RemoveMirroredFilesCommand(),
				new LogCommand(),
				new HelpCommand(),
				new VersionCommand());
	}
	...
	private static Options buildOptions()
	{
		...
		options.addOption(createOption("a", "master-fim-repository", true, "Fim repository directory that you want to use as master. Only for the remove mirrored files command", false));
